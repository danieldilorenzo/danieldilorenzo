...
**Ação:** Estudar frameworks como FastAPI ou Flask.
...
**Objetivo:** Docker, CI/CD e versionamento avançado.

**Ação:** Conteinerizar projetos Python e automatizar deploys no GitHub Actions.

**Projeto:** Configurar um pipeline de CI/CD para seus próprios scripts, garantindo qualidade de código.
...
**Projetos:** Concluir ao menos dois projetos práticos de automação em Python.
